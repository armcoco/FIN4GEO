...
for i=1:Row    
    for j=1:Col-1
        ...
        jjj=(i-1)*(Col)+j+1;
         if LL(j)>=3e3*exp(-(X(i)/1e3).^2)
            fprintf(fid,'%5d%5d%20d%#10.4G%#10.4G%#10.4G%#10.4G%#10.4G\n',iii,jjj, 1, Tratti(j+1)-X(j), D, AreaLat(j),0, 0);                   
         else
            fprintf(fid,'%5d%5d%20d%#10.4G%#10.4G%#10.4G%#10.4G%#10.4G\n',iii,jjj, 1, Tratti(j+1)-X(j), X(j+1)-Tratti(j+1), AreaLat(j),0, 0);                   
         end
    end
    h=h+1;
end
...
for i=1:Row-1   
    for j=1:Col
        ...
        jjj=(i)*(Col)+j;
        if LL(j)>=3e3*exp(-(X(i)/1e3).^2)
            fprintf(fid,'%5d%5d%20d%#10.4G%#10.4G%#10.4G%#10.4G%#10.4G\n',iii,jjj, 1, stepV/2, D, AreaVer(j),-1, 0);                   
        else
            fprintf(fid,'%5d%5d%20d%#10.4G%#10.4G%#10.4G%#10.4G%#10.4G\n',iii,jjj, 1, stepV/2, stepV/2, AreaVer(j),-1, 0);                   
        end       
    end
    h=h+1;
end
