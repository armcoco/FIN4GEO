...
%%%%%for Deformation
% Software='tough'; % tough or hydro or mufits
% Software='hydro'; % tough or hydro or mufits
Software='mufits'; % tough or hydro or mufits
...
elseif strcmp(Software,'mufits')
    pathSol='coupling_with_MUFITS/SCENARIO1/';
    MufitsSolFile=[pathSol,'SCENARIO1'];
    tt=loadMufitsTimes(MufitsSolFile);
    tt=tt/(365.25);
    Ntime=length(tt)-1;
end
...
V_maxFA=[];
V_maxFB=[];
selected_times=0:Ntime;
for iter=selected_times
