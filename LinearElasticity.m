...
global AS academic_test P f miu ni Radius DomInf IsPhi2 Grav_const Rb TRadius HydroSolFile ToughSolFile Software FileTopo Ks IfPhi2
...
[Phi1,Phi2,Alpha,Beta,G,NU,Xt1inv,Yt1inv]=controlDim(nn,mm,Phi1,Phi2,Alpha,Beta,G,NU,Xt1inv,Yt1inv);
...
% source term F
F.u = academic_test*fu_(Xu,Yu)-Xt1inv.*(dPx+dTx);
F.v = academic_test*fv_(Xu,Yu)-Yt1inv.*(dPy+dTy);
%dRho=drho__(Xu,Yu);
