...
Dw0=Sol(:,7);
Dg0=Sol(:,8);
Rho0=(Dw0.*(1-Sg0)+Dg0.*Sg0);
RRho0=reshape(Rho0,l,m);
SSGG0=reshape(Sg0,l,m);
PPHI=reshape(porosity,l,m);
...
%     RRho(XX>1000)=RRho0(XX>1000);
    
    subplot(3,2,1)
    [c,h]=contourf(XX,ZZ,RRho0);
    caxis([0 1000])
    xlim([0 3000])
    colorbar
    title(['density \rho_0 [kg/m^3],   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
    ...
    xlim([0 3000])
    colorbar
    title(['gas saturation \S_{g0},   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
    
    subplot(3,2,3)
    [c,h]=contourf(XX,ZZ,RRho);
    caxis([0 1000])
    xlim([0 3000])
    colorbar
    title(['density \rho [kg/m^3],   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
    ...
    xlim([0 3000])
    colorbar
    title(['gas saturation \S_{g},   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
    
    subplot(3,2,5)
    [c,h]=contourf(XX,ZZ,PPHI.*(RRho-RRho0));
    caxis([-150 250])
    xlim([0 3000])
    colorbar
    title(['density change \rho-\rho_0 [kg/m^3],   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
    ...
    xlim([0 3000])
    colorbar
    title(['gas saturation change \S_{g}-\S_{g0},   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
...
%     xlim([0 3000])
%     colorbar
%     title(['Temperature T_0 [C],   time: ',num2str(round(time_*100)/100),' years'],'FontSize',16)
