...
layer=-1490.0;
top=-10.0;
Row=(-layer+top)/stepV+1; %AAA Row=(-layer+top)/stepV+2;
Col=length(X);
D=1e-9;
% LL=[layer:stepV:top top+10]'; %AAA LL=[layer:stepV:top top+1]';
LL=[layer:stepV:top]'; %AAA LL=[layer:stepV:top top+1]';
...
fprintf(fid,'       0.0       0.0      1.15       0.0       0.0\n');
...
fprintf(fid,'       0.0   3.14E11     100.0   3.15E10                9.81       4.0       1.0\n');
...
%%%%%  FILE for TIMES  %%%%%%%%%%%%%%%%%%
times=[[0:1000:2000]';[2000.1:0.5:2010]']*86400*365';
l=length(times);
